...
void DeviceInit(){
  ...
  case 6:
    ...
    //Uncomment if you need to reset the RSSI array
    /*
    if(PhaseSelector()){
      flashSave.clearRSSI(RSSI, rp);
      flashSave.saveRSSI(RSSI,numRP);
    }
    */
